...
namespace TheSushiRoles 
{
    ...
    public class HudManagerUpdate 
    {
        ...
        public static void Postfix2(HudManager __instance) 
        {
            ...
            toggleSummaryButtonObject.SetActive(__instance.SettingsButton.gameObject.active && LobbyBehaviour.Instance && !Utils.PreviousEndGameSummary.IsNullOrWhiteSpace() && GameOptionsManager.Instance.currentGameOptions.GameMode != GameModes.HideNSeek 
