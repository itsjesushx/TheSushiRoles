...
namespace TheSushiRoles.Roles
{
    public class RoleInfo
    {
        ...
        public readonly static RoleInfo scavenger = new("Scavenger", Scavenger.Color, "Eat corpses to win", "Eat dead bodies", RoleId.Scavenger, Faction.Neutrals, RoleAlignment.NeutralEvil, $"The goal of the Scavenger is to eat {CustomGameOptions.ScavengerNumberToWin - Scavenger.eatenBodies} dead bodies to win.");
