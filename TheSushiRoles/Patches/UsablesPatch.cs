...
namespace TheSushiRoles.Patches
{
    ...
    public static class VentUsePatch
    {
        public static bool Prefix(Vent __instance)
        {
            ...
            bool jesterFlag = PlayerControl.LocalPlayer == Jester.Player && !CustomGameOptions.JesterCanMoveInVents;
    ...
    class EmergencyMinigameUpdatePatch
    {
        static void Postfix(EmergencyMinigame __instance)
        {
            ...
            if (Jester.Player != null && Jester.Player == PlayerControl.LocalPlayer && !CustomGameOptions.JesterCanCallEmergency)
            {
                CanCallEmergency = false;
            ...
            if (Prosecutor.Player != null && Prosecutor.Player == PlayerControl.LocalPlayer && !CustomGameOptions.ProsecutorCanCallEmergency)
            {
                CanCallEmergency = false;
