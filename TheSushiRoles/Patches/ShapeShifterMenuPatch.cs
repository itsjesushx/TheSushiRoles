...
{
    // Taken from Town of Us https://github.com/eDonnes124/Town-Of-Us-R/blob/master/source/Patches/NeutralRoles/PlayerMenu.cs/
    public class ShapeShifterMenu
    {
        ...
        public ShapeShifterMenu(Select click, Include inclusion)
        {
            Click = click;
            Inclusion = inclusion;
            if (Singleton != null)
